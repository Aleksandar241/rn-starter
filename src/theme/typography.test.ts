...
describe('generateFonts', () => {
  ...
  it('should generate correct font styles object', () => {
    ...
    expect(fonts).toMatchObject({
      ...
      'DEFAULT-MINIMAL/REGULAR': {fontFamily: 'Poppins-Regular', fontSize: 14},
      ...
      'DEFAULT-COMPACT/REGULAR': {fontFamily: 'Poppins-Regular', fontSize: 16},
      ...
      'DEFAULT-COZY/SEMI_BOLD': {fontFamily: 'Poppins-SemiBold', fontSize: 18},
      ...
      'DEFAULT-SPACIOUS/REGULAR': {fontFamily: 'Poppins-Regular', fontSize: 20},
      ...
      'DEFAULT-VAST/SEMI_BOLD': {fontFamily: 'Poppins-SemiBold', fontSize: 22},
